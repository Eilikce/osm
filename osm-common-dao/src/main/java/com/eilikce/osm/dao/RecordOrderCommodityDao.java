...
public interface RecordOrderCommodityDao {
	...
	/** 插入一条订单商品记录 **/
	int insertRecordOrderCommodity(RecordOrderCommodityPo recordOrderCommodityPo);
	
	/** 一次性插入多条订单商品记录 **/
	int insertRecordOrderCommodityList(List<RecordOrderCommodityPo> recordOrderCommodityPoList);
}
